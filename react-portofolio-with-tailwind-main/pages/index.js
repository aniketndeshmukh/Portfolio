  ...
  return (
    <div className={darkMode ? "dark" : ""}>
        ...
        <section className="min-h-screen ">
          <nav className="py-10 mb-12 flex justify-between dark:text-white bg-transparent z-20 shadow-md "  >
            ...
            <ul className="flex items-center lm:right-11">
              ...
              <li>
                <a href="#skills"><h2  className="sm:px-4 sm:py-1 lm:px-2 lm:py-1  ">Skills</h2></a>
              </li>
              <li>
                <BsFillMoonStarsFill
      ...
      <footer style={{width:'100%'}} className="h-60 p-20 bg-teal-600">
       <div  className=" relative mx-auto  flex w-fit  footmenu top-4  text-2xl "> <a href="#portfolio" className="pr-7 pt-1"><h3>Portfolio</h3></a> <a href="#skills" className="pr-3 pt-1" ><h3>Skills</h3></a > <a   href="mailto:aniketdeshmukh019@gmail.com" className="pr-2 pt-1"><AiFillMail className=" w-7 h-7"></AiFillMail></a> <a  href="https://www.linkedin.com/in/aniket-deshmukh-64386521b/" className="pr-2  pt-1"><AiFillLinkedin className="w-7 h-7"></AiFillLinkedin></a><a href="https://github.com/aniketndeshmukh" className="pr-2  pt-1"><AiFillGithub className="w-7 h-7 "></AiFillGithub></a></div> 
